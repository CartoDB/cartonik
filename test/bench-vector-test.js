...
const suites = [
  {
    threadingMode: '',
    uri: {
      xml: fs.readFileSync(path.resolve(path.join(__dirname, '/fixtures/mmls/bench-test.xml')), 'utf8'),
  ...
  },
  {
    threadingMode: 'auto',
    uri: {
      xml: fs.readFileSync(path.resolve(path.join(__dirname, '/fixtures/mmls/bench-test-auto.xml')), 'utf8'),
      base: path.join(__dirname, '/fixtures/datasources/shapefiles/world-borders/'),
      blank: false
    }
  },
  {
    threadingMode: 'async',
    uri: {
      xml: fs.readFileSync(path.resolve(path.join(__dirname, '/fixtures/mmls/bench-test-async.xml')), 'utf8'),
      base: path.join(__dirname, '/fixtures/datasources/shapefiles/world-borders/'),
      blank: false
    }
  }
