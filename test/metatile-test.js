  ...
  describe('zoom = 0', function () {
    describe('.first()', function () {
      it('.first({ x: 0, y: 0 })', function () {
        ...
        assert.deepStrictEqual(tile, { x: 0, y: 0 })
      })
    })
    ...
    describe('.tiles()', function () {
      it('.tiles({ z: 0, x: 0, y: 0 })', function () {
        ...
        assert.deepStrictEqual(tiles, [{ z, x, y, xOffsetInPixels, yOffsetInPixels }])
      })
    })
    ...
    describe('.boundingBox()', function () {
      it('.boundingBox({ z: 0, x: 0, y: 0 })', function () {
        ...
        assert.deepStrictEqual(bbox, [ -FULL, -FULL, FULL, FULL ])
      })
    })
  })
  ...
  describe('zoom = 1', function () {
    describe('.first()', function () {
      ...
      it('.first({ x: 1, y: 0 })', function () {
        ...
        assert.deepStrictEqual(tile, { x: 1, y: 0 })
      })
      ...
      it('.first({ x: 0, y: 1 })', function () {
        ...
        assert.deepStrictEqual(tile, { x: 0, y: 1 })
      })
      ...
      it('.first({ x: 1, y: 1 })', function () {
        ...
        assert.deepStrictEqual(tile, { x: 1, y: 1 })
      })
    })
    ...
    describe('.boundingBox()', function () {
      it('.boundingBox({ z: 1, x: 0, y: 0 })', function () {
        ...
        assert.deepStrictEqual(bbox, [ -FULL, HALF, HALF, FULL ])
      })
      ...
      it('.boundingBox({ z: 1, x: 1, y: 0 })', function () {
        ...
        assert.deepStrictEqual(bbox, [ HALF, HALF, FULL, FULL ])
      })
      ...
      it('.boundingBox({ z: 1, x: 0, y: 1 })', function () {
        ...
        assert.deepStrictEqual(bbox, [ -FULL, -FULL, HALF, HALF ])
      })
      ...
      it('.boundingBox({ z: 1, x: 1, y: 1 })', function () {
        ...
        assert.deepStrictEqual(bbox, [ HALF, -FULL, FULL, HALF ])
      })
    })
  })
})
  ...
  describe('zoom = 0', function () {
    describe('.first()', function () {
      ...
      it('.first({ x: 0, y: 0 })', function () {
        ...
        assert.deepStrictEqual(tile, quadrant0)
      })
    })
  ...
  describe('zoom = 2', function () {
    describe('.first()', function () {
      ...
      it('.first({ x: 2, y: 0 })', function () {
        ...
        assert.deepStrictEqual(tile, quadrant1)
      })
      ...
      it('.first({ x: 0, y: 2 })', function () {
        ...
        assert.deepStrictEqual(tile, quadrant2)
      })
      ...
      it('.first({ x: 2, y: 2 })', function () {
        ...
        assert.deepStrictEqual(tile, quadrant3)
      })
