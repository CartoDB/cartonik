...
describe('metatile (size = 4)', function () {
  ...
  describe('zoom = 1', function () {
    ...
    describe('.tiles()', function () {
      ...
      it('.tiles({ z: 1, x: 0, y: 0 }) => [ { 0, 0 }, { 0, 1 }, { 1, 0 }, { 1, 1 } ]', function () {
        const [ z, x, y ] = [ 1, 0, 0 ]
      ...
      it('.tiles({ z: 1, x: 1, y: 0 }) => [ { 0, 0 }, { 0, 1 }, { 1, 0 }, { 1, 1 } ]', function () {
        const [ z, x, y ] = [ 1, 1, 0 ]
      ...
      it('.tiles({ z: 1, x: 0, y: 1 }) => [ { 0, 0 }, { 0, 1 }, { 1, 0 }, { 1, 1 } ]', function () {
        const [ z, x, y ] = [ 1, 0, 1 ]
      ...
      it('.tiles({ z: 1, x: 1, y: 1 }) => [ { 0, 0 }, { 0, 1 }, { 1, 0 }, { 1, 1 } ]', function () {
        const [ z, x, y ] = [ 1, 1, 1 ]
