...
assert.vectorEqualsFile = function (filepath, vtile1, vtile2) {
  ...
  const v1 = vtile1.toJSON()
  const v2 = vtile2.toJSON()
  ...
  try {
    ...
    const e = filepath + '.expected.json'
    const a = filepath + '.actual.json'
    ...
    assert.ok(false, `File json representations differs: \n${e}\n${a}`)
  }
}
